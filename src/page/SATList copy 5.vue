  ...
  <div class="fillcontain">
        ...
        <el-tab-pane label="手动生成" >
          <el-form :inline="true" :model="formPara">
            <el-form-item label="名称">
              <el-input v-model="formPara.name"></el-input>
            </el-form-item>
            <el-form-item label="卫星个数">
              <el-input v-model="formPara.count"></el-input>
            </el-form-item>
            <el-form-item label="轨道面数">
              <el-input v-model="formPara.guidao"></el-input>
            </el-form-item>
            <el-form-item label="WalkerF">
              <el-input v-model="formPara.walk"></el-input>
            </el-form-item>
            <el-form-item label="RAAN扩展范围">
              <el-input v-model="formPara.raanfanwei"></el-input>
            </el-form-item>
          </el-form>
          <el-form :inline="true" :model="formPara">
            <el-form-item label="高度">
              <el-input v-model="formPara.height">
                <template slot="append">km</template>
              </el-input>
            </el-form-item>
            <el-form-item label="倾角">
              <el-input v-model="formPara.angle"></el-input>
            </el-form-item>
            <el-form-item label="离心率">
              <el-input v-model="formPara.lixin"></el-input>
            </el-form-item>
            <el-form-item label="RAAN">
              <el-input v-model="formPara.raan"></el-input>
            </el-form-item>
            <el-form-item label="真近点角">
              <el-input v-model="formPara.zhen"></el-input>
            </el-form-item>
            <el-form-item label="平近点角">
              <el-input v-model="formPara.ping"></el-input>
            </el-form-item>
        ...
        <el-tab-pane label="基于文件" >
          <div>
              <el-upload
                ...
                :file-list="fileList"
                :auto-upload="false"
                style="margin-top: 10px; margin-bottom: 10px; width:500px; float:left;"
              >
    ...
    <div class="table_container">
      ...
      >
        ...
        <el-table-column label="orbitPara_w" prop="rating"> </el-table-column>
        <el-table-column label="considx" width="160">
